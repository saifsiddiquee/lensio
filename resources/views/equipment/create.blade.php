...
@section('content')
    <div class="page-header-modern">
        <h1><i class="bi bi-camera-fill me-2" style="color: var(--warning-color);"></i>Add New Equipment</h1>
    ...
    <div class="card card-modern">
        <div class="card-body">
            <form action="{{ route('equipment.store') }}" method="POST" class="form-modern">
                @csrf
                <div class="row g-4">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('ownership_type') is-invalid @enderror" id="ownership_type"
                            ...
                            @foreach($ownershipTypes as $type)
                                <option value="{{ $type }}" {{ old('ownership_type', 'owned') == $type ? 'selected' : '' }}>
                                    {{ ucfirst($type) }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        <label for="purchase_cost" class="form-label">Purchase Cost (for owned)</label>
                ...
                <div class="mt-4 pt-3 border-top">
                    <button type="submit" class="btn btn-modern btn-modern-primary"><i class="bi bi-check-lg me-1"></i> Add
                        Equipment</button>
